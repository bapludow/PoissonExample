...
public class Poisson {
	...
	public Poisson(int[] squares) {
		...
		System.out.println("The observed probabilities are: " +Arrays.toString(observedProb));
		System.out.println("The observed frequency is " +Arrays.toString(squares));
		System.out.println("The Poisson Probability is " +Arrays.toString(poissonProb));
